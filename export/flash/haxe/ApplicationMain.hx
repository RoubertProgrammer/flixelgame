...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("UnJuegazo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("UnJuegazo", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "UnJuegazo";
		app.meta["name"] = "UnJuegazo";
		...
		#elseif !air
		app.window.context.attributes.background = 6750003;
